      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-6 border border-gray-100">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
            ...
            <Button onClick={() => navigate("/admin/menu/items/new")} className="shadow-md hover:shadow-lg transition-all">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <button onClick={() => handleSort("created_at")} className={`px-3 py-2 rounded-lg text-xs font-medium transition-all ${sortBy === "created_at" ? "bg-gradient-to-r from-orange-500 to-orange-600 text-white shadow-md" : "bg-gray-100 text-gray-600 hover:bg-gray-200"}`}>
                  Date <SortIcon field="created_at" />
                </button>
                <button onClick={() => handleSort("price")} className={`px-3 py-2 rounded-lg text-xs font-medium transition-all ${sortBy === "price" ? "bg-gradient-to-r from-orange-500 to-orange-600 text-white shadow-md" : "bg-gray-100 text-gray-600 hover:bg-gray-200"}`}>
                  Price <SortIcon field="price" />
                </button>
                <button onClick={() => handleSort("name")} className={`px-3 py-2 rounded-lg text-xs font-medium transition-all ${sortBy === "name" ? "bg-gradient-to-r from-orange-500 to-orange-600 text-white shadow-md" : "bg-gray-100 text-gray-600 hover:bg-gray-200"}`}>
                  Name <SortIcon field="name" />
                </button>
                <button onClick={() => handleSort("popularity")} className={`px-3 py-2 rounded-lg text-xs font-medium transition-all ${sortBy === "popularity" ? "bg-gradient-to-r from-orange-500 to-orange-600 text-white shadow-md" : "bg-gray-100 text-gray-600 hover:bg-gray-200"}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl shadow-lg p-6 text-white transform hover:scale-105 transition-transform">
            ...
            <p className="text-4xl font-bold">{items.filter(i => !i.is_deleted).length}</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl shadow-lg p-6 text-white transform hover:scale-105 transition-transform">
            ...
            <p className="text-4xl font-bold">{items.filter(i => !i.is_deleted && i.status === "available").length}</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-2xl shadow-lg p-6 text-white transform hover:scale-105 transition-transform">
            ...
            <p className="text-4xl font-bold">{items.filter(i => !i.is_deleted && i.is_chef_recommended).length}</p>
          </div>
              ...
              <table className="w-full">
                <thead className="bg-gradient-to-r from-gray-50 to-orange-50 border-b-2 border-gray-200">
                  <tr>
                    ...
                    <th className="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Chef Pick</th>
                ...
                <tbody className="divide-y divide-gray-100">
                  {paginatedItems.map((item) => (
                    <tr key={item.id} className="hover:bg-gradient-to-r hover:from-orange-50 hover:to-transparent transition-all">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="w-16 h-16 bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl flex items-center justify-center overflow-hidden shadow-sm">
                          {item.photos && item.photos.length > 0 ? (
                            <img
                              src={item.photos.find((p) => p.is_primary || p.isPrimary)?.url || item.photos[0]?.url}
                              alt={item.name}
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-center">
                        {item.is_chef_recommended ? (
                          <span className="text-2xl" title="Chef's Recommendation">⭐</span>
                        ) : (
                          <span className="text-gray-300">-</span>
                        )}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-center">
                        <span className={`inline-flex items-center justify-center w-10 h-10 rounded-lg font-bold ${item.popularity > 0 ? "bg-green-100 text-green-700" : "bg-gray-100 text-gray-400"}`}>
                          {item.popularity || 0}
                        </span>
                      </td>
